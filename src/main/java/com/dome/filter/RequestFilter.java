...
import com.dome.util.stringutil.StringUtilClass;
...
public class RequestFilter extends OncePerRequestFilter {
	...
	public String filter(HttpServletRequest request, String input) {
		...
		String[] noFilters = new String[] {
       		"teacherSaveHomeworkBaseRemote.action",
       		"saveRemote.action",
       		"saveHomeworkDaily.action",
       		"saveHomeworkDailyFromTest.action",
       		"subDailyRemote.action",
       		"saveDailyworkRemote.action",
       		"clientSaveOrUpdateMinicourseHomeworkRemote.action",
       		"saveMinicourseDaity.action",
		};
