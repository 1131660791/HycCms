    ...
    <div class="serverListBox">
        ...
        <div class="contentBox">
            <div class="tableBoxTitle clearfix">
                <select name="" id="" v-model="stateId">
                    <option value="" disabled selected hidden>课程状态</option>
                    <option :value="item.id" v-for="item in courseStateList" :key="item.id">{{item.departname}}</option>
                </select>
                <select name="" id="" v-model="platformId">
                    <option value="" disabled selected hidden>课程类型</option>
